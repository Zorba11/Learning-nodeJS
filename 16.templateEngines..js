...
app.get("/", function(req, res) {
  res.sendFile(__dirname + "/index.html"); //with express, we don't have to mention the content-type
});

app.get("/contact", function(req, res) {
  res.sendFile(__dirname + "/contact.html"); //with express, we don't have to mention the content-type
});
